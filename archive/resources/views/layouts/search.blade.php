    ...
    <div class="inner">
        <div class="content">
            ...
            <form action="{{ route('search-name') }}" method="GET" class="d-inline align-items-start">
                ...
                <button  class="btn textRed my-3" type="submit" style="width: 15rem; height: 4rem">Search by Event Name</button>
            </form>
            <form action="{{ route('search-type') }}" method="GET" class="d-inline align-items-start">
                ...
                <button  class="btn textRed my-3" type="submit" style="width: 15rem; height: 4rem" >Search by Type Of Event</button>
            </form>
        </div>
    </div>
@endsection